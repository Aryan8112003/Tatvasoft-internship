...
export class MissionService {
  ...
  getMissionThemeList(): Observable<MissionTheme[]> {
    // Corrected endpoint
    return this.http.get<MissionTheme[]>(`${this.apiUrl}/MissionTheme/GetMissionThemeList`)
  }

  getMissionSkillList(): Observable<MissionSkill[]> {
    // Corrected endpoint
    return this.http.get<MissionSkill[]>(`${this.apiUrl}/MissionSkill/GetMissionSkillList`)
  }
